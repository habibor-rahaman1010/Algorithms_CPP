...
int main(){
    ...
    adjacent_list[0].push_back(pair<int, int>(1, 2));
    adjacent_list[1].push_back({2, 4});
    adjacent_list[1].push_back({});
    adjacent_list[3].push_back({1, 7});
    adjacent_list[3].push_back(pair<int, int>(2, 8));
